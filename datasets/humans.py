"""
Dataset config for humans dataset.
...
class HumansDatasetConfig:
    ...
    protein_csv: str = "data/features/human_random/psepssm_features.csv"
    # Drug fingerprints NPZ (expected keys: 'drug_ids', 'fingerprints')
    drug_npz: str = "data/features/human_random/morgan_fingerprints.npz"
    # Interaction pairs (structured as: protein_id, drug_id, label per split)
    raw_data_dir: str = "data/raw/human_random"
