"""
Dataset config for BioSNAP dataset.
...
Usage:
    from datasets.biosnap import config
...
@dataclass
class BioSNAPDatasetConfig:
    """Configuration for BioSNAP DTI dataset."""

    dataset_name: str = "biosnap_random"
    ...
    protein_csv: str = "data/features/biosnap_random/psepssm_features.csv"
    # Drug fingerprints NPZ (expected keys: 'drug_ids', 'fingerprints')
    drug_npz: str = "data/features/biosnap_random/morgan_fingerprints.npz"
    # Interaction pairs (structured as: protein_id, drug_id, label per split)
    raw_data_dir: str = "data/raw/biosnap_random"
