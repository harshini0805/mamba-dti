"""
Dataset config for BindingDB dataset.
...
Usage:
    from datasets.bindingdb import config
...
@dataclass
class BindingDBDatasetConfig:
    """Configuration for BindingDB DTI dataset."""

    dataset_name: str = "bindingdb_random"
    ...
    protein_csv: str = "data/features/bindingdb_random/psepssm_features.csv"
    # Drug fingerprints NPZ (expected keys: 'drug_ids', 'fingerprints')
    drug_npz: str = "data/features/bindingdb_random/morgan_fingerprints.npz"
    # Interaction pairs (structured as: protein_id, drug_id, label per split)
    raw_data_dir: str = "data/raw/bindingdb_random"
