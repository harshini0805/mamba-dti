"""
Dataset config for Enzyme dataset (5-fold cross-validation).

This module defines data loading logic for 5-fold CV on Enzyme interactions.
"""
...
@dataclass
class EnzymeDatasetConfig:
    """Configuration for Enzyme DTI dataset."""

    dataset_name: str = "enzyme"
    ...
    # ─── Data File Paths ────────────────────────────────────────────────
    protein_csv: str = "data/features/enzyme/psepssm_features.csv"
    drug_npz: str = "data/features/enzyme/enzyme_morgan_fingerprints.npz"
    raw_interactions: str = "data/raw/enzyme/Drug_Target_Pair_Enzyme_COMPLETE.csv"
    ...
    def load_data(self) -> tuple:
        ...
        manifest_df = pd.read_csv(Path(self.drug_npz).parent / "enzyme_morgan_manifest.csv")
