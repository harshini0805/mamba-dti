"""
Dataset config for ic_complete dataset.
...
@dataclass
class IcCompleteDatasetConfig:
    """Configuration for humans DTI dataset."""

    dataset_name: str = "ic_complete"
    ...
    protein_csv: str = "data/features/ic_complete/psepssm_features.csv"
    # Drug fingerprints NPZ (expected keys: 'drug_ids', 'fingerprints')
    drug_npz: str = "data/features/ic_complete/morgan_fingerprints.npz"
    # Interaction pairs (structured as: protein_id, drug_id, label per split)
    raw_data_dir: str = "data/raw/ic_complete"
...
config = IcCompleteDatasetConfig()
