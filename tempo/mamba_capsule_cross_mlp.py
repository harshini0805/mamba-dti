...
if __name__ == "__main__":
    ...
    protein_features = load_protein_features(
        ...
        "/Cross Attention/HINMTDTI/Mamba_Capsule/Data/psepssm_features.csv"
    )

    drug_embeddings = torch.load(
        "/mnt/c/Users/Harshini J/Engineering/Projects/Nimisha Ma'am - Project"
        "/Cross Attention/HINMTDTI/DrugBank/Embeddings/drugs_drugbank_embeddings.pt"
    )

    interactions = pd.read_csv(
        "/mnt/c/Users/Harshini J/Engineering/Projects/Nimisha Ma'am - Project"
        "/Cross Attention/HINMTDTI/DrugBank/Data/Drug_Target_Pair_DrugBank_COMPLETE_FIXED.csv"
    )
