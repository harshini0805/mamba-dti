"""
Configuration for Mamba+MLP DTI architecture.
...
class MambaMLPConfig:
    ...
    results_dir: Path = Path("architectures/mamba_mlp_fp/results")
    logs_dir: Path = Path("architectures/mamba_mlp_fp/logs")
    checkpoints_dir: Path = Path("architectures/mamba_mlp_fp/checkpoints")
